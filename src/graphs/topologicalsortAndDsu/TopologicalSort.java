...
/**
 * Problem Description
Given a directed acyclic graph having A nodes. A matrix B of size M x 2 is given which represents the M edges such that there
...
Output Format
Return a one-dimensional array denoting the topological ordering of the graph and if it doesn't exist then return empty array.
