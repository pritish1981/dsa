...
The legendary Farmer John is throwing a huge party, and animals from all over the world are hanging out at his house. His guests are hungry,
so he instructs his cow Bessie to bring out the snacks! Moo!
There are A snacks flavors, numbered with integers 1,2,…,A. Bessie has A snacks, one snack of each flavor. There are M guests and every guest has exactly
two favorite flavors. The procedure for eating snacks will go as follows:
...
public class CowAndSnacks {
	...
	public static void main(String[] args) {
		int A = 5; // snacks flavors
		int[][] B = { { 1, 2 }, { 4, 3 }, { 1, 4 }, { 3, 4 } }; // two favorite flavors
		System.out.println("Minimum number of sad guests::" + solve(A, B));
